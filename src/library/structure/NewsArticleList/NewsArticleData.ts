...
export const NewsArticleFilters = {
  ...
  services: uri.hasQueryParam(NewsArticleFilterFields.services.queryParamKey)
    ? uri.getQueryParamValue(NewsArticleFilterFields.services.queryParamKey)
    : 'all-services',
...
export const newsArticleData: NewsArticleListProps = {
  ...
  results: [
    ...
    },
    {
      ...
      excerpt:
        'Sint Lorem consectetur in commodo esse culpa anim id. Consectetur occaecat sint sit consectetur aliquip irure eiusmod quis minim. Excepteur tempor aliquip dolor voluptate id exercitation dolore est est.',
      date: 1614178638,
      image720x405:
      ...
      image72x41:
        'https://cms-staging.westnorthants.gov.uk/sites/default/files/styles/responsive/public/72/41/0/2022-02/HMD-Facebook-graphic_3.jpg',
      url: 'http://',
    },
    {
      ...
      excerpt:
        'Eu mollit ea laboris et proident occaecat velit in incididunt aliqua velit duis. Enim elit incididunt aliqua id minim nostrud Lorem. Esse quis velit nostrud anim aliquip veniam cupidatat fugiat aliqua.',
      date: 1614178638,
      image720x405:
    ...
    },
    {
      ...
      excerpt:
        'Cupidatat veniam minim nulla sint et quis quis esse laborum. Qui eu id nostrud dolore et ipsum nostrud nisi incididunt. Sint dolor ea proident adipisicing officia aliqua ea mollit duis sint ipsum aute ut. Irure non do veniam minim quis. Esse commodo sint occaecat occaecat. Ex ea nulla pariatur est.',
      date: 1614178638,
      image720x405:
      ...
      image72x41:
        'https://cms-staging.westnorthants.gov.uk/sites/default/files/styles/responsive/public/72/41/0/2022-01/For%20The%20Love%20Of%20Books%20-%20logo%20-%20landscape.png',
      url: 'http://',
    },
    {
      ...
      excerpt:
        'Et qui culpa cillum sunt eu laboris nisi adipisicing esse. Elit sunt commodo qui eu est sit id dolor tempor non nisi. Ea do incididunt ad ea ut aliqua laboris cupidatat incididunt exercitation sit quis consequat duis. Do voluptate sunt eu aliquip id irure ad eu quis occaecat. Occaecat duis eiusmod aliqua ad incididunt laboris duis.',
      date: 1614178638,
      image720x405:
    ...
    },
    {
      ...
      excerpt:
        'Occaecat proident enim et do excepteur ad commodo. Culpa occaecat cupidatat cupidatat adipisicing amet. Sit quis ipsum aute reprehenderit cupidatat tempor et non esse veniam deserunt anim eu.',
      date: 1614178638,
      image720x405: '',
      image72x41: '',
      url: 'http://',
    ...
    },
    {
      ...
      excerpt:
        'Aute excepteur exercitation amet adipisicing ad ex cupidatat fugiat quis do. Magna laborum elit dolore do eiusmod aliqua nostrud officia tempor anim ex. Officia exercitation amet sunt ullamco dolore mollit nulla velit et et tempor adipisicing ea. Mollit sit laborum occaecat commodo laborum et nisi sit.',
      date: 1614178638,
      image720x405: '',
      image72x41: '',
      url: 'http://',
    ...
    },
    {
      ...
      excerpt:
        'Nostrud ullamco elit sint laborum veniam laboris adipisicing. Officia ex aute est proident nostrud proident. Id pariatur pariatur duis aliquip non laboris consectetur cillum ea. Laborum exercitation eu proident ut.',
      date: 1614178638,
      image720x405: '',
      image72x41: '',
      url: 'http://',
