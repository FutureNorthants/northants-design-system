...
const DirectoryAddToShortList: React.FunctionComponent<DirectoryAddToShortListProps> = ({ id, name, snippet }) => {
  ...
  return (
    <Styles.AddToShortlist onClick={(e) => toggleFavourites(id, name, snippet)} data-testid="DirectoryAddToShortList">
      <svg
      ...
      {isFavourite(id) ? <>Remove from shortlist</> : <>Add to shortlist</>}
