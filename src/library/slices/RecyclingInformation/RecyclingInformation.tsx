  ...
  const innerHTML = `
    <c9-recycling-info
        ...
        style="--theme-c9- --theme-c9-primary-text-color:${themeContext.theme_vars.colours.black};
         ...
         --theme-c9-disposal-options-card-color: ${themeContext.theme_vars.colours.action_dark};
         ...
         --theme-c9-item-highlight-color: ${themeContext.theme_vars.colours.secondary};
