...
const Template: Story<PostCodeAddressDropdownProps> = (args) => <SBPadding><MaxWidthContainer><PostCodeAddressProvider><PostCodeAddressSearch /><PostCodeAddressDropdown {...args} /></PostCodeAddressProvider></MaxWidthContainer></SBPadding>;
