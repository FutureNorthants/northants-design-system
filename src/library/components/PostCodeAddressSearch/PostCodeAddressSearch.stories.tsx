...
const Template: Story<PostCodeAddressSearchProps> = (args) => <SBPadding><MaxWidthContainer><PostCodeAddressProvider value={value}><PostCodeAddressSearch {...args} /></PostCodeAddressProvider></MaxWidthContainer></SBPadding>;
