...
FindYourBinCollectionDayWestExample.args = {
  signpostLinksArrayExample: [
    {
      sovereignCode: 2,
      areaName: 'Daventry',
...
FindYourBinCollectionDaySingleExample.args = {
  signpostLinksArrayExample: [
    {
      sovereignCode: 2,
...
export const SingleExampleWithServiceAlert = Template.bind({});
SingleExampleWithServiceAlert.args = {
