      ...
      <PageStructures.MaxWidthContainer>
        ...
        <PageStructures.PageWithSidebarContainer>
          <PageStructures.PageMain>
            ...
            <p>
              Your property is placed in one of 8 valuation bands by the Listing Officer at the Valuation Office Agency.
              New properties are allocated a band by determining the amount that the dwelling might reasonably expect to
              realise if it had been sold.
            </p>

            <p>
              If you think your council tax band is wrong, you can contact the Valuation Office (VOA) by email to{' '}
              <a href="mailto:ctonline@voa.gov.uk">ctonline@voa.gov.uk</a> to explain why you think it is wrong.
              Alternatively, call 03000 501 501.
            </p>

            {renderVersionSwitch(version)}

            <p>
              You can also <a href="#">download all council tax charges in West Northants</a> in CSV format
            </p>
          </PageStructures.PageMain>
